...
SourceMonitor - Freeware Version 2.5.1.0 - May 31, 2009
...
Win2000, WinXP, and Vista. To install it, just run the SMSetupVnnnn.exe program
...
Language coverage: C++, C, C#, VB.NET, Delphi, Java, Visual Basic (VB6), HTML.
...
All bugs through number 114 have been fixed. Bugs are posted at:
...
1) Add an export option to create graphics files for charted data, particularly
   Kiviat graphs.

2) Speed up writing of project checkpoints.

If either of these are important to you, please send me an email.
